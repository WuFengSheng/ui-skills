---
name: "search"
description: "Search 搜索 -- uView UI uni-app Vue2 组件/工具。Invoke when user needs Search 搜索 in uni-app Vue 2.x project."
url: "https://www.uviewui.com/components/search.html"
---

---
name: "codeInput"
description: "CodeInput 验证码输入 -- uView UI uni-app Vue2 组件/工具。Invoke when user needs CodeInput 验证码输入 in uni-app Vue 2.x project."
url: "https://www.uviewui.com/components/codeInput.html"
---
